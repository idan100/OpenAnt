...
If you want today's Claude default and nothing else, skip the wizard:
...
This uses the built-in `openant-default` config (compiled into the binary, no `config.json` needed) — Claude Sonnet 5 across every phase.
